...
\section{Summary}
In overall it is very professional organization, since every team is responsible for provision and maintenance of some specific services, have full control of it and nobody else is entitled to interrupt with their work. At the same time teams inside IS work together to provide best service for the end user and ensure the service continuity. There is logical structure for whole teams in IS and it look professional. 
