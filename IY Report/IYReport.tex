...
\section{Room Checks}
As I have already said in section ~\ref{sec:faqs} we perform room checks to determine any equipment with faults and we do it a few times during term time.   All permanent employees are responsible for lecture rooms and as it used to be IYs take responsibility over big computer rooms. Room check means that we need to check computers
