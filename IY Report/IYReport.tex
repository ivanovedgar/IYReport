...
Computer Workshop is a big In the workshop 
\section{Interzone}
...
Computer Workshop Technical Environment is probably most unusual in comparison to the rest of the IS. Here we not only deal with software related issues, but a hardware as well: soldiering, computer part replacement, cleaning after spillages, equipment shifting, hardware diagnostics basically all unusual jobs come here. Here I will describe usual tools that we use most of all. 
