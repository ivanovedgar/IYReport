...
\section{Summary}
In overall I think it is very professional organization, every team is responsible for provision and maintenance of some specific service, have full control over it and nobody else is entitled to interrupt with their work. At the same time teams inside IS collaborate and work together on matters that affect more than one team. There is also logical hierarchy of management staff: director -$>$ manager -$>$ team leader which ensures that staff feedback is taken in account at the highest level. All together people in IS work to provide the best service for the end user and ensure the service continuity. I felt working in a highly professional organization where everybody knows their place and is expert in his/her filed of knowledge.
...
\section{Summary}
I would like to say that there is now single point of control for all of the systems in IS. People who work in IS need to know their way around to use services efficiently. At the beginning I found it a bit frustrating since I needed to memorize so many systems, but in a few weeks a get used to it.
\chapter{What I did}
...
All the casing was taken away and I spotted the problem straight away: it was the power jack. It seemed to be fine from the outside having motherboard uncovered revealed that is was dislodged from the it. After soldiering the power jack back to the motherboard (figure ~\ref{fig:power jack}) and assembling the laptop back it started working straight away. To find out what the problem was I worked out the most obvious issues first then moving to the more complicated and managed to identify and fix the problem quickly and efficiently.
...
During the first few weeks I was afraid that my knowledge may not be sufficient enough to perform well at work, but as the time passed I got the ropes. I noticed that there are similarities in faults with software like MS Outlook, EndNote, VPN connections, browser problems and off course Windows itself. Nobody expected me learn everything at once and I was taught gradually about the systems we use and how work should be performed in a right way.

\section{Interacting with people}
I gained huge amount of knowledge during the placement. In the workshop I learned technical stuff like taking laptops and PCs apart, improved my soldiering skills, learned different techniques of trouble shooting hardware and software issues. I enjoyed working with hardware stuff in particular because it is interesting for me. People in the team that I was working in were very helpful and could provide advice on any question that I had. My team leader was good as well providing with help and support when I needed it, however sometimes he was asking me to do other jobs right in the middle of my work or before I was going to meet the customer who I informed about the visit. I suppose it will happen quite often in the industry when I will work for full time. It took me around 3 month to fully understand how organization and systems function to preform jobs on my own without asking for help. At the end it was about knowing some small bits and pieces of information to perform well at work. Once when I was on call some gentleman asked me why his phone doesn't work. At that time it was first time I would deal with such query and I had no idea who is responsible for configuring phone in IS. When I returned to the workshop I was told that phones are managed by Systems team and I should speak to them.

It was about interacting with people from the other teams as well, if would need working network point at some location, I would have to speak with somebody from the Networking team and they would do it for me. In the beginning when I need assistance from the other teams I felt like being left for my own, I would be told to "go and speak to those people", but who do I speak to exactly and what should I ask for? I had to find out it by self and sometimes look stupid asking inappropriate questions. 

\section{Windows Domains}
Having hundreds of people in the organization and providing them all with computing facilities may be difficult. Local user account on the each machine would not make any sense. People quite often forget to logoff form the websites that they used and leave personal files on the computer. It may be dangerous since next person who uses the same computer may use left information in a bad way. I learned about Windows domains which makes computer management and maintenance easier. By having one designated computer (also called domain controller) to store accounts for users and computers makes it possible for each user to log on with their credentials to any computer which is part of the domain. Although domain administration was not in my one of my duties I kept asking responsible people how all this stuff is configured and functions. I found such configuration very interesting and clever. I will definitely use my knowledge in this area in future I will have to set up my own business.
